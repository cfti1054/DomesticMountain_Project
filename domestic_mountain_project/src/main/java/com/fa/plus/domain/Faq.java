...
public class Faq {
	...
	public int getFaq_reg_id() {
		return faq_reg_id;
	}
	public void setFaq_reg_id(int faq_reg_id) {
		this.faq_reg_id = faq_reg_id;
	}
	public int getFaq_update_id() {
		return faq_update_id;
	}
	public void setFaq_update_id(int faq_update_id) {
	...
	public int getFaq_visible() {
		return faq_visible;
	}
	public void setFaq_visible(int faq_visible) {
		this.faq_visible = faq_visible;
	}
