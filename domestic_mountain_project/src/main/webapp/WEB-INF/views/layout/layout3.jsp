...
// <![CDATA[
var colours=new Array("#60b2ea", "#60b2ea", "#60b2ea", "#60b2ea", "#ccc"); // colours for top, right, bottom and left borders and background of bubbles
...
<link rel="stylesheet"
	...
	type="text/css">
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/resources/css/mountain.css"
	type="text/css">
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/resources/css/mountain_detail.css"
	type="text/css">
<link rel="stylesheet"
...
<link rel="stylesheet"
	...
	type="text/css">
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/resources/css/buy.css"
	type="text/css">
...
<body>
	...
	<div class="login" id="login">
		<form name="modelLoginForm" id="loginForm" class="login__form"
			method="post">
			...
			<div>
				...
				<a href="${pageContext.request.contextPath}/user/pwdFind"
					class="login__forgot"> 비밀번호를 잊으셨나요? </a>

				<button type="button" class="login__button"
					onclick="sendModelLogin();">로그인</button>
			</div>
		</form>
