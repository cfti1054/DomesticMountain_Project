					...
					<tbody>
						...
						<tr>
							<td colspan="2">이전글 : <c:if test="${not empty prevDto}">
									<a
										href="${pageContext.request.contextPath}/ootd/article?${query}&post_num=${prevDto.post_num}">${prevDto.post_title}</a>
								</c:if>
							</td>
						</tr>
						<tr>
							<td colspan="2">다음글 : <c:if test="${not empty nextDto}">
									<a
										href="${pageContext.request.contextPath}/ootd/article?${query}&post_num=${nextDto.post_num}">${nextDto.post_title}</a>
								</c:if>
							</td>
						</tr>
					</tbody>
