	...
	<script type="text/javascript">
		function deleteBoard() {
		    if(confirm('게시글을 삭제 하시 겠습니까 ? ')) {
			    ...
			    let url = '${pageContext.request.contextPath}/ootd/delete?' + query;
		    	location.href = url;
		    }
		}
	</script>
			...
			<div class="notice-container">
					...
					<tbody>
							...
							<td colspan="2"><c:if test="${not empty dto.saveFilename}">
									<p class="border text-secondary my-1 p-2">
										<i class="bi bi-folder2-open"></i> <a
											href="${pageContext.request.contextPath}/ootd/download?post_num=${dto.post_num}">${dto.originalFilename}</a>
									</p>
								</c:if></td>
						</tr>
						...
						<tr>
							<td colspan="2">&nbsp;<c:if test="${not empty prevDto}">
									<a class="font-array"
										href="${pageContext.request.contextPath}/ootd/article?${query}&post_num=${prevDto.post_num}"><span class="a-span">이전글 : </span>${prevDto.post_title}</a>
								</c:if>
							</td>
						</tr>
						<tr>
							<td colspan="2">&nbsp;<c:if test="${not empty nextDto}">
									<a class="font-array"
										href="${pageContext.request.contextPath}/ootd/article?${query}&post_num=${nextDto.post_num}"><span class="a-span">다음글 : </span>${nextDto.post_title}</a>
								</c:if>
							</td>
						</tr>
					</tbody>
				...
				<table class="table table-borderless mb-2">
					<tr>
						<td width="50%"><c:choose>
								<c:when test="${sessionScope.loginUser.userid==dto.user_id}">
									<button type="button" class="btn btn-light"
										onclick="location.href='${pageContext.request.contextPath}/ootd/update?post_num=${dto.post_num}&page=${page}';">수정</button>
								</c:when>
								<c:otherwise>
						...
						<td class="text-end">
							<button type="button" class="btn btn-light"
								onclick="location.href='${pageContext.request.contextPath}/ootd/list?${query}';">리스트</button>
						</td>
					</tr>
				</table>
...
$(function(){
	$('.btnSendBoardLike').click(function(){
		...
		let url = '${pageContext.request.contextPath}/ootd/insertBoardLike';
...
function listPage(page) {
	let url = '${pageContext.request.contextPath}/ootd/listReply';
...
$(function(){
	$('.btnSendReply').click(function(){
		...
		let url = '${pageContext.request.contextPath}/ootd/insertReply';
...
$(function(){
	$('.reply').on('click', '.deleteReply', function(){
		...
		let url = '${pageContext.request.contextPath}/ootd/deleteReply';
...
$(function(){
	...
	$('.reply').on('click', '.btnSendReplyLike', function(){
		...
		let url = '${pageContext.request.contextPath}/ootd/insertReplyLike';
...
function listReplyAnswer(reply_answer) {
	let url = '${pageContext.request.contextPath}/ootd/listReplyAnswer';
...
function countReplyAnswer(reply_answer) {
	let url = '${pageContext.request.contextPath}/ootd/countReplyAnswer';
	let query = 'reply_answer=' + reply_answer;
...
$(function(){
	$('.reply').on('click', '.hideReply', function(){
		...
		let url = '${pageContext.request.contextPath}/ootd/replyShowHide';
