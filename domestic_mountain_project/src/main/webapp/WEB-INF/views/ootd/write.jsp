...
<script type="text/javascript">
	function check() {
		...
		f.action = "${pageContext.request.contextPath}/ootd/${mode}";
	...
	<div class="body-container">
		...
		<div class="contentWrap">
			...
			<div class="notice-container">
				<form name="ootdForm" method="post"
						...
						<tr>
							<td class="text-center">
								...
								<button type="button" class="btn btn-light"
									onclick="location.href='${pageContext.request.contextPath}/ootd/list';">${mode=='update'?'수정취소':'등록취소'}&nbsp;<i
										class="bi bi-x"></i>
...
<c:if test="${mode=='update'}">
	<script type="text/javascript">
		function deleteFile(file_num) {
			...
			let url = "${pageContext.request.contextPath}/ootd/deleteFile?file_num="
