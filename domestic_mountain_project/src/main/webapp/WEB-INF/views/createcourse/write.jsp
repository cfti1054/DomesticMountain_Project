...
<script type="text/javascript">
	function check() {
		const f = document.createcourseForm;
		let str;
		...
		f.action = "${pageContext.request.contextPath}/createcourse/${mode}";
...
<section class="features-1">
	<div class="body-container">
		...
		<div class="contentWrap">
			...
			<div class="amain">
				<h1 class="amain-main">
					<a>회원들의 모습<span>| Members' createcourse</span></a> <span><a
			...
			<div class="notice-container">
				<form name="createcourseForm" method="post"
								...
								<td>
									<p class="form-control-plaintext">
										<c:if test="${not empty dto.saveFilename}">
											<a href="javascript:deleteFile('${dto.file_num}');"><i
						...
						<tr>
							<td class="text-center">
								...
								<button type="button" class="btn btn-light"
									onclick="location.href='${pageContext.request.contextPath}/createcourse/list';">${mode=='update'?'수정취소':'등록취소'}&nbsp;<i
										class="bi bi-x"></i>
...
<c:if test="${mode=='update'}">
	<script type="text/javascript">
		function deleteFile(file_num) {
			...
			let url = "${pageContext.request.contextPath}/createcourse/deleteFile?file_num="
