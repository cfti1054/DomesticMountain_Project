...
<c:choose>
	...
	<c:when test="${mode=='show' && type=='board'}">
		<table class="table td-border mx-auto my-10" style="width: 99%;">
			<tr>
				<td width="30%" class="text-center bg-light">1:1 질문</td>
				<td width="70%" class="ps-3"><textarea class="input" name="faq_question" id="faq_question" cols="70" rows="2" readonly>${dto.inquiry_board_title}</textarea></td>
			</tr>
			
			<tr>
						<td class="text-center bg-light">작성자</td>
						<td class="ps-5">${dto.inquiry_board_reg_id}</td>
						<td class="text-center bg-light">등록일자</td>
						<td class="ps-5">${dto.inquiry_board_reg_date}</td>
			</tr>
			
			
			<tr>
				<td class="text-center bg-light">질문 내용</td>
				<td colspan="3" class="ps-3"><textarea class="input" name="faq_content" id="faq_content" cols="70" rows="7" readonly>${dto.inquiry_board_content}</textarea></td>	
			</tr>
	...
	<form name="answerWriteForm" method="post" id="answerWriteForm">
		<table class="table td-border mx-auto my-10" style="width: 99%;">
			<tr>
				<td width="30%" class="text-center bg-light">1:1 질문</td>
				<td width="70%" class="ps-3"><textarea class="input" name="inquiry_board_title" id="inquiry_board_title" cols="70" rows="2" readonly>${dto.inquiry_board_title}</textarea></td>
			</tr>
			
			<tr>
						<td width="20%" class="text-center bg-light">질문 작성자</td>
						<td width="30%" class="ps-5">${dto.inquiry_board_reg_id}</td>
						<td width="20%" class="text-center bg-light">질문 등록일자</td>
						<td width="30%" class="ps-5">${dto.inquiry_board_reg_date}</td>
			</tr>
			
			<tr>
				<td class="text-center bg-light">질문 내용</td>
				<td colspan="3" class="ps-3">
					<textarea class="input" name="inquiry_board_content" id="inquiry_board_content" cols="70" rows="5" readonly>${dto.inquiry_board_content}</textarea>
				</td>	
			</tr>
			<tr>
				<td>1:1 답변 제목</td>
	...
	<c:when test="${mode=='update' && type=='answer'}">
		...
		<table class="table td-border mx-auto my-10" style="width: 99%;">
			...
			<tr>
				<td class="text-center bg-light">질문 내용</td>
				<td colspan="3" class="ps-3"><textarea class="input" name="inquiry_board_content" id="inquiry_board_content" cols="70" rows="5" readonly>${dto.inquiry_board_content}</textarea></td>	
			</tr>
			...
			<tr>
				<td>1:1 답변 제목</td>
				<td class="ps-5">
					<textarea class="input" name="inquiry_answer_title" id="inquiry_answer_title" cols="35" rows="3" required>
						${dto.inquiry_answer_title}
					</textarea>
				</td>
			</tr>
