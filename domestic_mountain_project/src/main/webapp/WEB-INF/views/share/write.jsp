...
<section class="features-1">
	<div class="body-container">
		...
		<div class="contentWrap">
			...
			<div class="amain">
				<h1 class="amain-main">
					<a>회원들의 모습<span>| Members' share</span></a> <span><a
						...
						<tr>
							<td class="text-center">
								...
								<button type="button" class="btn btn-light"
									onclick="location.href='${pageContext.request.contextPath}/share/list';">${mode=='update'?'수정취소':'등록취소'}&nbsp;<i
										class="bi bi-x"></i>
...
<c:if test="${mode=='update'}">
	<script type="text/javascript">
		function deleteFile(file_num) {
			...
			let url = "${pageContext.request.contextPath}/share/deleteFile?file_num="
