					...
					<ul>
						<li class=""><a
							href="${pageContext.request.contextPath}/recommend/list">&gt;
								추천 코스</a></li>
						<li class=""><a
							href="${pageContext.request.contextPath}/share/list">&gt; 유저가
								만든 코스</a></li>
				...
				<div class="section">
					<div class="article-album-sub">
						<c:forEach var="dto" items="${list}" varStatus="status">
							<ul>
								<li class="show-2-li">
									<c:url var="url" value="/share/article">
									...
									<a href="${url}" class="album-img"> <img width="200" height="200"
										src="${pageContext.request.contextPath}/uploads/share/${dto.saveFilename}" alt="">
									</a>
						...
						<div class="row board-list-footer">
							<div class="col">
								<button type="button" class="btn btn-light" onclick="location.href='${pageContext.request.contextPath}/share/list';"
									title="새로고침">
							...
							<div class="col-6 text-end">
								<form class="row text-end-row" name="searchForm" action="#"
									...
									<div class="col-auto p-1">
										...
										<button type="button" class="btn btn-light"
											onclick="location.href='${pageContext.request.contextPath}/share/write';">글올리기</button>
									</div>
								</form>
							</div>
						</div>
