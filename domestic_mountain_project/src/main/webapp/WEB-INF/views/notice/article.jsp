			...
			<table class="table mt-5 mb-0 board-article">
				...
				<tbody>
					<tr>
						...
						<td align="right">
							${dto.notice_reg_date} | 조회 ${dto.notice_hit_count}
						</td>
					</tr>
					...
					<tr>
						<td colspan="2">
							...
							<c:if test="${not empty prevDto}">
								<a href="${pageContext.request.contextPath}/notice/article?${query}&notice_category_num=${prevDto.notice_category_num}">${prevDto.notice_title}</a>
							</c:if>
						</td>
					</tr>
					<tr>
						<td colspan="2">
							...
							<c:if test="${not empty nextDto}">
								<a href="${pageContext.request.contextPath}/notice/article?${query}&notice_category_num=${nextDto.notice_category_num}">${nextDto.notice_title}</a>
							</c:if>
						</td>
					</tr>
				</tbody>
